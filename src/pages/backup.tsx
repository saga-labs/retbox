  ...
  return (
    <main className="flex w-screen h-screen text-gray-700">
        <div className="flex flex-col items-center flex-shrink-0 w-16 border-r border-gray-300 bg-gray-200 py-3">
            <a className="w-10 h-10 rounded-lg bg-gray-400 hover:bg-gray-500" href="#"></a>
            <a className="w-10 h-10 rounded-lg bg-gray-400 mt-4 shadow-outline border-4 border-gray-200" href="#"></a>
            <a className="relative w-10 h-10 rounded-lg bg-gray-400 mt-4 hover:bg-gray-500" href="#">
                <span className="absolute w-3 h-3 rounded-full bg-blue-400 top-0 right-0 -mt-1 -mr-1"></span>
            </a>
            <a className="w-10 h-10 rounded-lg bg-gray-400 mt-4 hover:bg-gray-500" href="#"></a>
            <a className="flex items-center justify-center w-10 h-10 rounded-lg bg-transparent mt-4 hover:bg-gray-400" href="#">
                ...
                <div className="mt-4">
                    ...
                    <div id="messages_list">
                        <a className="flex items-center h-8 hover:bg-gray-300 text-sm pl-8 pr-3" href="#">
                            ...
                            <span className="flex items-center justify-center bg-blue-500 rounded-full font-medium h-5 px-2 ml-auto text-xs text-white">3</span>
                        </a>
                        <a className="flex items-center h-8 hover:bg-gray-300 text-sm pl-8 pr-3" href="#">
                            <div className="flex justify-center w-4">
                                <span className="w-2 h-2 rounded-full bg-blue-500"></span>
                        ...
                        <a className="flex items-center h-8 hover:bg-gray-300 text-sm pl-8 pr-3" href="#">
                            ...
                            <span className="flex items-center justify-center bg-blue-500 rounded-full font-medium h-5 px-2 ml-auto text-xs text-white">1</span>
                        </a>
                        <a className="flex items-center h-8 hover:bg-gray-300 text-sm pl-8 pr-3" href="#">
                            <div className="flex justify-center items-center rounded bg-gray-600 w-4 h-4">
        ...
        <div className="flex flex-col flex-grow">
            ...
            <div className="flex flex-col flex-grow overflow-auto">
                ...
                <div className="flex flex-col items-center mt-2">
                    <hr className="w-full"/>
                    <span className="flex items-center justify-center -mt-3 bg-white h-6 px-3 rounded-full border text-xs font-semibold mx-auto">Today</span>
                </div>
                <div className="flex px-4 py-3">
                    <div className="h-10 w-10 rounded flex-shrink-0 bg-gray-300"></div>
                    <div className="ml-2">
                ...
                <div className="flex px-4 py-3">
                    ...
                    <div className="ml-2">
                        ...
                        <p className="text-sm">It is a gift. A gift to the foes of Mordor. Why not use this Ring? (paces) Long has my father, the Steward of Gondor, kept the forces of Mordor at bay. By the blood of our people are your lands kept safe! Give Gondor the weapon of the Enemy. Let us use it against him!</p>
                        <div className="flex space-x-2 mt-1">
                            <button className="flex items-center pl-1 pr-2 h-5 bg-gray-300 hover:bg-gray-400 rounded-full text-xs">
                                <span>👎</span>
                ...
                <div className="flex px-4 py-3">
                    ...
                    <div className="ml-2">
                        ...
                        <p className="text-sm">You cannot wield it! None of us can. The One Ring answers to Sauron alone. It has no other master.</p>
                    </div>
                </div>
                <div className="flex px-4 py-3">
                    <div className="h-10 w-10 rounded flex-shrink-0 bg-gray-300"></div>
                ...
                <div className="flex px-4 py-3">
                    ...
                    <div className="ml-2">
                        ...
                        <p className="text-sm">This is no mere ranger. He is Aragorn, son of Arathorn. You owe him your allegiance.</p>
                    </div>
                </div>
                <div className="flex px-4 py-3">
                    <div className="h-10 w-10 rounded flex-shrink-0 bg-gray-300"></div>
                ...
                <div className="flex px-4 py-3">
                    ...
                    <div className="ml-2">
                        ...
                        <p className="text-sm">The Ring cannot be destroyed, Gimli, son of Gloin by any craft that we here possess. The Ring was made in the fires of Mount Doom. Only there can it be unmade. It must be taken deep into Mordor and cast back into the fiery chasm from whence it came.</p>
                ...
                <div className="flex px-4 py-3">
                    ...
                    <div className="ml-2">
                        ...
                        <p className="text-sm">One does not simply walk into Mordor. Its black gates are guarded by more than just orcs. There is evil there that does not sleep. And the great Eye is ever watchful. It is a barren wasteland riddled with fire and ash and dust. The very air you breathe is a poisonous fume. Not with ten thousand men could you do this. It is folly!</p>
                    </div>
                </div>
            ...
            <div className="h-12 bg-white px-4 pb-4">
                <div className="flex items-center border-2 border-gray-300 rounded-sm p-1">
                    ...
                    <textarea className="flex-grow text-sm px-3 border-l border-gray-300 ml-1 resize-none" placeholder="Message council-of-elrond" rows={3} />
                    <button className="flex-shrink flex items-center justify-center h-6 w-6 rounded hover:bg-gray-200">
                        <svg className="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="flex flex-col flex-grow overflow-auto">
                ...
                <div className="bg-gray-100 px-4 pb-3 mt-auto">
                    <div className="flex flex-col items-center border-2 border-gray-300 rounded-sm p-1">
                        <textarea className="w-full text-sm px-3 bg-transparent resize-none" placeholder="Reply…" rows={1} />
